...
internal struct MTSDFParameters
{
    ...
    *********/
    ...
    public MTSDFParameters(float screenPixelRange, MTSDFFillType fillType, MTSDFBorderType borderType, float borderWidth, Colour32 fillColour, Colour32 borderColour)
    {
