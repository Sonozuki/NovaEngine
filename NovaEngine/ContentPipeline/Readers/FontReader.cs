...
public class FontReader : IContentReader
{
    ...
    *********/
    ...
    /// <inheritdoc/>
    public Type[] OutputTypes => new[] { typeof(Core.Font) };
    ...
    *********/
    ...
    public unsafe object? Read(FileStream novaFileStream, Type outputType)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            var horizontalMetrics = new HorizontalMetrics(binaryReader.ReadUInt16(), binaryReader.ReadInt16());

            glyphs.Add(new(character, size, atlasPosition, horizontalMetrics));
        }

        return new Core.Font(name, maxGlyphHeight, pixelRange, atlas, glyphs);
    }
}
