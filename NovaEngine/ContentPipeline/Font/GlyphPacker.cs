...
internal static class GlyphPacker
{
    ...
    *********/
    ...
    public static bool TryPack(ImmutableArray<Glyph> glyphs, int padding)
    {
        ...
        while (remainingGlyphs.Any())
        {
            ...
            var scaledBounds = bestGlyph.ScaledBounds;
            scaledBounds.X = halfPadding + bestSpace.X;
            scaledBounds.Y = halfPadding + bestSpace.Y;
            bestGlyph.ScaledBounds = scaledBounds;
