...
public struct Matrix3x2D : IEquatable<Matrix3x2D>
{
    ...
    *********/
    ...
    public Matrix3x2D(in Vector2<double> row1, in Vector2<double> row2, in Vector2<double> row3)
    {
        M11 = row1.X;
        M12 = row1.Y;
        M21 = row2.X;
    ...
    public static Matrix3x2D CreateRotation(double angle) => new(Matrix2x2D.CreateRotation(angle));

    /// <summary>Creates a scale matrix.</summary>
    /// <param name="scale">The uniform scale factor.</param>
    /// <returns>The created matrix.</returns>
    public static Matrix3x2D CreateScale(double scale) => new(Matrix2x2D.CreateScale(scale));

    /// <summary>Creates a scale matrix.</summary>
    /// <param name="xScale">The scale factor of the X axis.</param>
    /// <param name="yScale">The scale factor of the Y axis.</param>
    /// <returns>The created matrix.</returns>
    public static Matrix3x2D CreateScale(double xScale, double yScale) => new(Matrix2x2D.CreateScale(xScale, yScale));

    /// <summary>Creates a scale matrix.</summary>
    /// <param name="scale">The scale factor of the X and Y axis.</param>
    /// <returns>The created matrix.</returns>
    public static Matrix3x2D CreateScale(Vector2<double> scale) => new(Matrix2x2D.CreateScale(scale));
