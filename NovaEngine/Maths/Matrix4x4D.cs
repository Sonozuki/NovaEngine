...
namespace NovaEngine.Maths
{
    ...
    public struct Matrix4x4D : IEquatable<Matrix4x4D>
    {
        ...
        *********/
        ...
        public double Determinant => M11 * new Matrix3x3D(M22, M23, M24, M32, M33, M34, M42, M43, M44).Determinant
        ...
        public Matrix4x4D TranslationRemoved
        {
            get
            {
                var matrix = this;
        ...
        public Matrix4x4D RotationRemoved
        {
            get
            {
                var matrix = this;
        ...
        public Matrix4x4D ScaleRemoved
        {
            get
            {
                var matrix = this;
        ...
        public Matrix4x4D ProjectionRemoved
        {
            get
            {
                var matrix = this;
        ...
        public QuaternionD Rotation => new Matrix3x3D(M11, M12, M13, M21, M22, M23, M31, M32, M33).Rotation;

        /// <summary>The scale of the matrix.</summary>
        public Vector3D Scale => new(Row1.XYZ.Length, Row2.XYZ.Length, Row3.XYZ.Length);

        /// <summary>The projection of the matrix.</summary>
        public Vector4D Projection => Column4;
        ...
        *********/
        ...
        public Matrix4x4D(Vector4D row1, Vector4D row2, Vector4D row3, Vector4D row4)
        {
            M11 = row1.X;
            M12 = row1.Y;
            M13 = row1.Z;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix2x2D matrix, double m13 = 0, double m14 = 0, double m23 = 0, double m24 = 0, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = m13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix2x3D matrix, double m14 = 0, double m24 = 0, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix2x4D matrix, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix3x2D matrix, double m13 = 0, double m14 = 0, double m23 = 0, double m24 = 0, double m33 = 1, double m34 = 0, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = m13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix3x3D matrix, double m14 = 0, double m24 = 0, double m34 = 0, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix3x4D matrix, double m41 = 0, double m42 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m43">The third element of the fourth row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix4x2D matrix, double m13 = 0, double m14 = 0, double m23 = 0, double m24 = 0, double m33 = 1, double m34 = 0, double m43 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = m13;
        ...
        /// <param name="m34">The fourth element of the third row.</param>
        /// <param name="m44">The fourth element of the fourth row.</param>
        public Matrix4x4D(Matrix4x3D matrix, double m14 = 0, double m24 = 0, double m34 = 0, double m44 = 1)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        public Matrix4x4 ToMatrix4x4() => new((float)M11, (float)M12, (float)M13, (float)M14, (float)M21, (float)M22, (float)M23, (float)M24, (float)M31, (float)M32, (float)M33, (float)M34, (float)M41, (float)M42, (float)M43, (float)M44);

        /// <inheritdoc/>
        public bool Equals(Matrix4x4D other) => this == other;

        /// <inheritdoc/>
        public override bool Equals(object? obj) => obj is Matrix4x4D matrix && this == matrix;

        /// <inheritdoc/>
        public override int GetHashCode() => (M11, M12, M13, M14, M21, M22, M23, M24, M31, M32, M33, M34, M41, M42, M43, M44).GetHashCode();
        ...
        public static Matrix4x4D CreateFromQuaternion(QuaternionD quaternion)
        {
            ...
            return Matrix4x4D.CreateFromAxisAngle(axis, angle);
        }
