...
namespace NovaEngine.Maths
{
    ...
    public struct Vector4D : IEquatable<Vector4D>
    {
        ...
        *********/
        ...
        public readonly Vector4D Normalised
        {
            get
            {
                var vector = this;
        ...
        *********/
        ...
        /// <param name="z">The Z component of the vector.</param>
        /// <param name="w">The W component of the vector.</param>
        public Vector4D(in Vector2D xy, double z = 0, double w = 0)
        {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        ...
        public Vector4D(in Vector2D xy, in Vector2D zw)
        {
            X = xy.X;
            Y = xy.Y;
            Z = zw.X;
        ...
        /// <param name="w">The W component of the vector.</param>
        public Vector4D(in Vector3D xyz, double w = 0)
        {
            X = xyz.X;
            Y = xyz.Y;
            Z = xyz.Z;
        ...
        public readonly Vector4 ToVector4() => new((float)X, (float)Y, (float)Z, (float)W);
        ...
        public readonly Vector4I ToFlooredVector4I() => new((int)Math.Floor(X), (int)Math.Floor(Y), (int)Math.Floor(Z), (int)Math.Floor(W));
        ...
        public readonly Vector4I ToRoundedVector4I() => new((int)Math.Round(X), (int)Math.Round(Y), (int)Math.Round(Z), (int)Math.Round(W));
        ...
        public readonly Vector4I ToCeilingedVector4I() => new((int)Math.Ceiling(X), (int)Math.Ceiling(Y), (int)Math.Ceiling(Z), (int)Math.Ceiling(W));

        /// <inheritdoc/>
        public readonly bool Equals(Vector4D other) => this == other;

        /// <inheritdoc/>
        public readonly override bool Equals(object? obj) => obj is Vector4D vector && this == vector;
        ...
        public static double Distance(in Vector4D vector1, in Vector4D vector2) => Math.Sqrt(Vector4D.DistanceSquared(vector1, vector2));
        ...
        /// <remarks>This is preferred for comparison as it avoids the square root operation.</remarks>
        public static double DistanceSquared(in Vector4D vector1, in Vector4D vector2) => (vector2.X - vector1.X) * (vector2.X - vector1.X) + (vector2.Y - vector1.Y) * (vector2.Y - vector1.Y) + (vector2.Z - vector1.Z) * (vector2.Z - vector1.Z) + (vector2.W - vector1.W) * (vector2.W - vector1.W);
        ...
        public static double Dot(in Vector4D vector1, in Vector4D vector2) => vector1.X * vector2.X + vector1.Y * vector2.Y + vector1.Z * vector2.Z + vector1.W * vector2.W;

        /// <summary>Creates a vector using the smallest of the corresponding components from two vectors.</summary>
        /// <param name="vector1">The first vector.</param>
        /// <param name="vector2">The second vector.</param>
        /// <returns>The component-wise minimum.</returns>
        public static Vector4D ComponentMin(in Vector4D vector1, in Vector4D vector2) => new(Math.Min(vector1.X, vector2.X), Math.Min(vector1.Y, vector2.Y), Math.Min(vector1.Z, vector2.Z), Math.Min(vector1.W, vector2.W));

        /// <summary>Creates a vector using the largest of the corresponding components from two vectors.</summary>
        /// <param name="vector1">The first vector.</param>
        /// <param name="vector2">The second vector.</param>
        /// <returns>The component-wise maximum.</returns>
        public static Vector4D ComponentMax(in Vector4D vector1, in Vector4D vector2) => new(Math.Max(vector1.X, vector2.X), Math.Max(vector1.Y, vector2.Y), Math.Max(vector1.Z, vector2.Z), Math.Max(vector1.W, vector2.W));
        ...
        public static Vector4D Clamp(in Vector4D value, in Vector4D min, in Vector4D max) => new(MathsHelper.Clamp(value.X, min.X, max.X), MathsHelper.Clamp(value.Y, min.Y, max.Y), MathsHelper.Clamp(value.Z, min.Z, max.Z), MathsHelper.Clamp(value.W, min.W, max.W));
        ...
        public static Vector4D Lerp(in Vector4D value1, in Vector4D value2, double amount) => new(MathsHelper.Lerp(value1.X, value2.X, amount), MathsHelper.Lerp(value1.Y, value2.Y, amount), MathsHelper.Lerp(value1.Z, value2.Z, amount), MathsHelper.Lerp(value1.W, value2.W, amount));

        /// <summary>Transforms a vector by a matrix.</summary>
        /// <param name="position">The source position.</param>
        /// <param name="matrix">The transformation matrix.</param>
        /// <returns>The transformed vector.</returns>
        public static Vector4D Transform(in Vector2D position, in Matrix4x4D matrix)
        {
            return new(
        ...
        public static Vector4D Transform(in Vector2D vector, in QuaternionD rotation)
        {
        ...
        /// <param name="matrix">The transformation matrix.</param>
        /// <returns>The transformed vector.</returns>
        public static Vector4D Transform(in Vector3D position, in Matrix4x4D matrix)
        {
            return new(
        ...
        /// <param name="rotation">The rotation to apply.</param>
        /// <returns>The rotated vector.</returns>
        public static Vector4D Transform(in Vector3D vector, in QuaternionD rotation)
        {
            var x2 = rotation.X + rotation.X;
            var y2 = rotation.Y + rotation.Y;
            var z2 = rotation.Z + rotation.Z;
        ...
        /// <param name="matrix">The transformation matrix.</param>
        /// <returns>The transformed vector.</returns>
        public static Vector4D Transform(in Vector4D position, in Matrix4x4D matrix)
        {
            return new(
        ...
        /// <param name="rotation">The rotation to apply.</param>
        /// <returns>The rotated vector.</returns>
        public static Vector4D Transform(in Vector4D vector, in QuaternionD rotation)
        {
            var x2 = rotation.X + rotation.X;
            var y2 = rotation.Y + rotation.Y;
            var z2 = rotation.Z + rotation.Z;
