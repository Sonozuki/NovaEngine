...
namespace NovaEngine.Maths
{
    ...
    public struct Matrix3x2 : IEquatable<Matrix3x2>
    {
        ...
        *********/
        ...
        public Matrix2x3 Transposed => new(M11, M21, M31, M21, M22, M32);
        ...
        *********/
        ...
        public Matrix3x2(Vector2 row1, Vector2 row2, Vector2 row3)
        {
            M11 = row1.X;
            M12 = row1.Y;
            M21 = row2.X;
        ...
        /// <param name="m31">The first element of the third row.</param>
        /// <param name="m32">The second element of the third row.</param>
        public Matrix3x2(Matrix2x2 matrix, float m31 = 0, float m32 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M21 = matrix.M21;
        ...
        public Matrix3x2D ToMatrix3x2D() => new(M11, M12, M21, M22, M31, M32);
        ...
        /// <inheritdoc/>
        public override int GetHashCode() => (M11, M12, M21, M22, M31, M32).GetHashCode();
        ...
        /// <returns>The created matrix.</returns>
        public static Matrix3x2 CreateScale(float scale) => new(scale, 0, 0, scale, 0, 0);

        /// <summary>Creates a scale matrix.</summary>
        /// <param name="xScale">The scale factor of the X axis.</param>
        /// <param name="yScale">The scale factor of the Y axis.</param>
        /// <returns>The created matrix.</returns>
        public static Matrix3x2 CreateScale(float xScale, float yScale) => new(xScale, 0, 0, yScale, 0, 0);

        /// <summary>Creates a scale matrix.</summary>
        /// <param name="scale">The scale factor of the X and Y axis.</param>
        /// <returns>The created matrix.</returns>
        public static Matrix3x2 CreateScale(Vector2 scale) => new(scale.X, 0, 0, scale.Y, 0, 0);
