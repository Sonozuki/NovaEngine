...
namespace NovaEngine.Maths
{
    ...
    public struct Matrix3x4D : IEquatable<Matrix3x4D>
    {
        ...
        *********/
        ...
        public Matrix4x3D Transposed => new(M11, M21, M31, M12, M22, M32, M13, M23, M33, M14, M24, M34);

        /// <summary>The matrix without the rotation.</summary>
        public Matrix3x4D RotationRemoved
        {
            get
            {
                var matrix = this;
        ...
        public Matrix3x4D ScaleRemoved
        {
            get
            {
                var matrix = this;
        ...
        *********/
        ...
        /// <param name="m33">The third element of the third row.</param>
        /// <param name="m34">The fourth element of the third row.</param>
        public Matrix3x4D(Matrix2x2D matrix, double m13 = 0, double m14 = 0, double m23 = 0, double m24 = 0, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = m13;
        ...
        /// <param name="m33">The third element of the third row.</param>
        /// <param name="m34">The fourth element of the third row.</param>
        public Matrix3x4D(Matrix2x3D matrix, double m14 = 0, double m24 = 0, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m33">The third element of the third row.</param>
        /// <param name="m34">The fourth element of the third row.</param>
        public Matrix3x4D(Matrix2x4D matrix, double m31 = 0, double m32 = 0, double m33 = 1, double m34 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        /// <param name="m33">The third element of the third row.</param>
        /// <param name="m34">The fourth element of the third row.</param>
        public Matrix3x4D(Matrix3x2D matrix, double m13 = 0, double m14 = 0, double m23 = 0, double m24 = 0, double m33 = 1, double m34 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = m13;
        ...
        /// <param name="m24">The fourth element of the second row.</param>
        /// <param name="m34">The fourth element of the third row.</param>
        public Matrix3x4D(Matrix3x3D matrix, double m14 = 0, double m24 = 0, double m34 = 0)
        {
            M11 = matrix.M11;
            M12 = matrix.M12;
            M13 = matrix.M13;
        ...
        public Matrix3x4 ToMatrix3x4() => new((float)M11, (float)M12, (float)M13, (float)M14, (float)M21, (float)M22, (float)M23, (float)M24, (float)M31, (float)M32, (float)M33, (float)M34);

        /// <inheritdoc/>
        public bool Equals(Matrix3x4D other) => this == other;

        /// <inheritdoc/>
        public override bool Equals(object? obj) => obj is Matrix3x4D matrix && this == matrix;
