...
namespace NovaEngine.Maths
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        *********/
        ...
        public Vector3I ToFlooredVector3I() => new((int)MathF.Floor(X), (int)MathF.Floor(Y), (int)MathF.Floor(Z));
        ...
        public Vector3I ToRoundedVector3I() => new((int)MathF.Round(X), (int)MathF.Round(Y), (int)MathF.Round(Z));
        ...
        public Vector3I ToCeilingedVector3I() => new((int)MathF.Ceiling(X), (int)MathF.Ceiling(Y), (int)MathF.Ceiling(Z));
        ...
        public static float Distance(Vector3 vector1, Vector3 vector2) => MathF.Sqrt(Vector3.DistanceSquared(vector1, vector2));
        ...
        /// <remarks>This is preferred for comparison as it avoids the square root operation.</remarks>
        public static float DistanceSquared(Vector3 vector1, Vector3 vector2) => (vector2.X - vector1.X) * (vector2.X - vector1.X) + (vector2.Y - vector1.Y) * (vector2.Y - vector1.Y) + (vector2.Z - vector1.Z) * (vector2.Z - vector1.Z);
        ...
        public static Vector3 ComponentMin(Vector3 vector1, Vector3 vector2) => new(Math.Min(vector1.X, vector2.X), Math.Min(vector1.Y, vector2.Y), Math.Min(vector1.Z, vector2.Z));

        /// <summary>Creates a vector using the largest of the corresponding components from two vectors.</summary>
        /// <param name="vector1">The first vector.</param>
        /// <param name="vector2">The second vector.</param>
        /// <returns>The component-wise maximum.</returns>
        public static Vector3 ComponentMax(Vector3 vector1, Vector3 vector2) => new(Math.Max(vector1.X, vector2.X), Math.Max(vector1.Y, vector2.Y), Math.Max(vector1.Z, vector2.Z));
        ...
        public static Vector3 Clamp(Vector3 value, Vector3 min, Vector3 max) => new(MathsHelper.Clamp(value.X, min.X, max.X), MathsHelper.Clamp(value.Y, min.Y, max.Y), MathsHelper.Clamp(value.Z, min.Z, max.Z));
        ...
        public static Vector3 Lerp(Vector3 value1, Vector3 value2, float amount) => new(MathsHelper.Lerp(value1.X, value2.X, amount), MathsHelper.Lerp(value1.Y, value2.Y, amount), MathsHelper.Lerp(value1.Z, value2.Z, amount));
